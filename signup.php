...
<html lang="en">
  ...
  <body>
    ...
    <hr>
    <?php
    // Show messages from signup handler
    if (isset($_GET['error'])) {
      $err = $_GET['error'];
      $msg = '';
      switch ($err) {
        case 'emptyInput': $msg = 'Please fill in all fields.'; break;
        case 'enterValidNumber': $msg = 'Please enter a valid phone number.'; break;
        case 'invalidemail': $msg = 'Please enter a valid email address.'; break;
        case 'pwdnotmatch': $msg = 'Passwords do not match.'; break;
        case 'emailTaken': $msg = 'Email is already registered.'; break;
        case 'dbprepare': $msg = 'Server error preparing request. Try again later.'; break;
        case 'dberror': $msg = 'Database error while creating account. Try again.'; break;
