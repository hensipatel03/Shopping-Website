...
<nav class="desktop-navigation-menu">
  <div class="container">
    <ul class="desktop-menu-category-list">
      ...
      <li class="menu-category">
        <a href="#" class="menu-title">Jeans</a>
      </li>
      <li class="menu-category">
        <a href="#" class="menu-title">Trousers</a>
      </li>
      <li class="menu-category">
      ...
      <div class="product-box">
        <div class="product-main">
          <div class="product-grid">
            <?php
            $men_items = get_items_by_category_and_subcategory($category_ID, 'Men');
            while ($row = mysqli_fetch_assoc($men_items)) {
            ?>
              <div class="showcase">
                <div class="showcase-banner">
                  <img src="./admin/upload/<?php echo $row['product_img'] ?>" alt="Men's Product" width="300" class="product-img default" />
                  <img src="./admin/upload/<?php echo $row['product_img'] ?>" alt="Men's Product" width="300" class="product-img hover" />
                </div>
